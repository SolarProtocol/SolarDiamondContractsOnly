...
contract ERC777Facet is IERC777, IERC20 {
    ...
    function burn(uint256 amount, bytes memory data) external {
        ...
        LibSoloToken.burn(LibContext.msgSender(), amount, data, "", true);
    }
    ...
    function operatorSend(
        ...
        require(
            LibSoloToken.isOperatorFor(LibContext.msgSender(), sender),
    ...
    function operatorBurn(
        ...
        require(
            LibSoloToken.isOperatorFor(LibContext.msgSender(), account),
            "ERC777: caller is not an operator for holder"
        );
        LibSoloToken.burn(account, amount, data, operatorData, true);
    }
